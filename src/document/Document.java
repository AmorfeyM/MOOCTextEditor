...
public abstract class Document {
	...
	public static void testCase(Document doc) {
		System.out.println(doc.getText() + "\n");
		System.out.println("Test Flesch Score method.....\n");
		System.out.println("Flesch Score of text: " + doc.getText());
		System.out.printf("%.2f", doc.getFleschScore());
	}
	...
	public double getFleschScore()
	{
		...
		double tempRes1 = (double)(getNumWords())/getNumSentences();
		double tempRes2 = (double)(getNumSyllables())/getNumWords();
		double fleshScore = 206.835 - (1.015 * tempRes1)  - (84.6 * tempRes2);
