...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		Object[] arrayTokens = tokens.toArray();
		if (isWord(arrayTokens[arrayTokens.length-1].toString())) {
			numSentences++;
		}
	}
...
//		         32, 15, 1);
		EfficientDocument testObject = new EfficientDocument("Lorem ipsum dolor sit amet? qui ex choro quodsi moderatius. nam dolores. explicari forensibus ad");
		testObject.processText();
		System.out.println(testObject.numWords);
		System.out.println(testObject.numSentences);
		System.out.println(testObject.numSyllables);
	}
